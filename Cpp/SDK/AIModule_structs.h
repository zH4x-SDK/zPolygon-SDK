...
{
	unsigned char                                      UnknownData_Y6FG[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIDataProviderTypedValue : public FAIDataProviderValue
{
	...
	unsigned char                                      UnknownData_0A9K[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FAIDataProviderBoolValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_LA7G[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAIDataProviderFloatValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_H7J9[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FAIDamageEvent
{
	...
	unsigned char                                      UnknownData_TQL3[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_S6MM[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OTTQ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FAIPredictionEvent
{
	...
	unsigned char                                      UnknownData_9HLB[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1CF3[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_87PD[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAISenseAffiliationFilter
{
	...
	unsigned char                                      UnknownData_IVL5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FAIMoveRequest
{
	...
	unsigned char                                      UnknownData_ZONP[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
struct FBTDecoratorLogic
{
	...
	unsigned char                                      UnknownData_BLDO[0x1];                                     // 0x0001(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBehaviorTreeTemplateInfo
{
	...
	unsigned char                                      UnknownData_148N[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FBlackboardEntry
{
	...
	unsigned char                                      UnknownData_EF79[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FBlackboardKeySelector
{
	...
	unsigned char                                      UnknownData_E8SR[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QWLJ[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDynamicParam
{
	...
	unsigned char                                      UnknownData_HIIE[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEQSParametrizedQueryExecutionRequest
{
	...
	unsigned char                                      UnknownData_ILU0[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SK02[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (PADDING)
...
struct FIntervalCountdown
{
	...
	unsigned char                                      UnknownData_72T5[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (PADDING)
...
struct FEnvNamedValue
{
	...
	unsigned char                                      UnknownData_B6AM[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Value;                                                     // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FEnvTraceData
{
	...
	unsigned char                                      UnknownData_9JQI[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JWY5[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDataProviderIntValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_5OKE[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FEnvDirection
{
	...
	unsigned char                                      UnknownData_K1PX[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FEnvQueryInstanceCache
{
	...
	unsigned char                                      UnknownData_2WDZ[0x170];                                   // 0x0008(0x0170) MISSED OFFSET (PADDING)
...
struct FEnvOverlapData
{
	...
	unsigned char                                      UnknownData_TOIS[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_19KX[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FPawnActionEvent
{
	...
	unsigned char                                      UnknownData_4MFG[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FAIStimulus
{
	...
	unsigned char                                      UnknownData_Q5FY[0xC];                                     // 0x002C(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      UnknownData_TACB : 1;                                      // 0x0038(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_N2M2[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3PG4[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FActorPerceptionBlueprintInfo
{
	...
	unsigned char                                      UnknownData_KSLQ[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QYYC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEnvQueryRequest
{
	...
	unsigned char                                      UnknownData_6XEN[0x50];                                    // 0x0018(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HMK8[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UB65[0x14];                                    // 0x0018(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DVCC[0xC];                                     // 0x0034(0x000C) MISSED OFFSET (PADDING)
