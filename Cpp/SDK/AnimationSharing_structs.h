...
struct FAnimationSetup
{
	...
	unsigned char                                      UnknownData_EZYN[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimationStateEntry
{
	...
	unsigned char                                      UnknownData_QTP5[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WO9R[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HQI2[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9GK5[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimationSharingScalability
{
	...
	unsigned char                                      UnknownData_OIE9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_FW83[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
