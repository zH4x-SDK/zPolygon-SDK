...
public:
	...
	unsigned char                                      UnknownData_IBGL[0x7];                                     // 0x0691(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_25MN[0x3];                                     // 0x06A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R69Q[0x10];                                    // 0x06B0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VJHN[0xA0];                                    // 0x06D0(0x00A0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_S6JP[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GZOC[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CJ8T[0x28];                                    // 0x0090(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_H017[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (PADDING)
