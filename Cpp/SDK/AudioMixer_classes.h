...
{
public:
	unsigned char                                      UnknownData_3NKE[0x8];                                     // 0x01F8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_SWP8[0x3];                                     // 0x0649(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RYD8[0x4];                                     // 0x0654(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C27S[0x20];                                    // 0x0668(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TLRM[0x28];                                    // 0x0698(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SDSU[0x80];                                    // 0x0028(0x0080) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZHRX[0x168];                                   // 0x0028(0x0168) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6705[0x78];                                    // 0x0068(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_8SHB[0x38];                                    // 0x0068(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_XG7I[0x68];                                    // 0x0068(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_RI5P[0x50];                                    // 0x0030(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LZDW[0x18];                                    // 0x03C8(0x0018) MISSED OFFSET (PADDING)
