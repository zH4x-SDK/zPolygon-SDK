...
struct FSubmixEffectDynamicProcessorFilterSettings
{
	...
	unsigned char                                      UnknownData_LZK3[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubmixEffectDynamicsProcessorSettings
{
	...
	unsigned char                                      UnknownData_2RLS[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3BF5[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FZTY[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FSubmixEffectEQBand
{
	...
	unsigned char                                      UnknownData_Q59W[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FSubmixEffectReverbSettings
{
	...
	unsigned char                                      UnknownData_KHLB[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GIE3[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BYZR[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
