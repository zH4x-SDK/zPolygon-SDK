...
struct FARSessionPayload
{
	...
	unsigned char                                      UnknownData_WD92[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARPlaneUpdatePayload
{
	...
	unsigned char                                      UnknownData_LLYX[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JMGX[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D704[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FARFaceUpdatePayload
{
	...
	unsigned char                                      UnknownData_3H7M[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QT0D[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_DVI4[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  WorldTransform;                                            // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_Z7BL[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_N654[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  WorldTransform;                                            // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_DH4O[0xF];                                     // 0x0051(0x000F) MISSED OFFSET (PADDING)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_62DO[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  WorldTransform;                                            // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_ZBBD[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARSkeletonDefinition
{
	...
	unsigned char                                      UnknownData_X48Q[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARPose3D
{
	...
	unsigned char                                      UnknownData_K2HE[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FARTraceResult
{
	...
	unsigned char                                      UnknownData_GCQR[0xB];                                     // 0x0005(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YYOJ[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (PADDING)
...
struct FARSessionStatus
{
	...
	unsigned char                                      UnknownData_YNQ2[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
