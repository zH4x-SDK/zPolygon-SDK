...
// BlueprintGeneratedClass BP_Item_Skin_StandartSkin.BP_Item_Skin_StandartSkin_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Item_Skin_StandartSkin.BP_Item_Skin_StandartSkin_C");
		return ptr;
	}
