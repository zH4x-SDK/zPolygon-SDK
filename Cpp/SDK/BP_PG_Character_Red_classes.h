...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PG_Character_Red.BP_PG_Character_Red_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PG_Character_Red(int EntryPoint);
};
