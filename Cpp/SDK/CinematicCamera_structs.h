...
struct FCameraLookatTrackingSettings
{
	...
	unsigned char                                      UnknownData_CDZ6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TK20[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LT6V[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FCameraTrackingFocusSettings
{
	...
	unsigned char                                      UnknownData_871F[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FCameraFocusSettings
{
	...
	unsigned char                                      UnknownData_EYEE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2K7M[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JBQE[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MJ1M[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FNamedFilmbackPreset
{
	...
	unsigned char                                      UnknownData_4V13[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
