...
struct FClothLODDataCommon
{
	...
	unsigned char                                      UnknownData_I26R[0x3];                                     // 0x0139(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VN6Y[0x20];                                    // 0x0140(0x0020) MISSED OFFSET (PADDING)
...
struct FClothConfig_Legacy
{
	...
	unsigned char                                      UnknownData_TL2N[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IR7L[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothParameterMask_Legacy
{
	...
	unsigned char                                      UnknownData_8BQS[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A0W9[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T2YE[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
