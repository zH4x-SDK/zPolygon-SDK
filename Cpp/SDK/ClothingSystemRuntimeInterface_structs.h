...
struct FClothCollisionPrim_Box
{
	...
	unsigned char                                      UnknownData_B6K9[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothCollisionPrim_Convex
{
	...
	unsigned char                                      UnknownData_XRFP[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
