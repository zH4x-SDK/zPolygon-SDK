...
struct FDatasmithCameraLookatTrackingSettingsTemplate
{
	...
	unsigned char                                      UnknownData_UDW8[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithCameraFocusSettingsTemplate
{
	...
	unsigned char                                      UnknownData_VABR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithPostProcessSettingsTemplate
{
	...
	unsigned char                                      UnknownData_QEYZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3Z8X[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YLT9[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithTessellationOptions
{
	...
	unsigned char                                      UnknownData_V338[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FDatasmithMeshBuildSettingsTemplate
{
	...
	unsigned char                                      UnknownData_EK4C[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithRetessellationOptions : public FDatasmithTessellationOptions
{
	...
	unsigned char                                      UnknownData_O8CQ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FDatasmithImportBaseOptions
{
	...
	unsigned char                                      UnknownData_G9LB[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
