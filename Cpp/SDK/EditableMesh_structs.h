...
struct FAdaptorPolygon2Group
{
	...
	unsigned char                                      UnknownData_7BSI[0x3C];                                    // 0x000C(0x003C) MISSED OFFSET (PADDING)
...
struct FAdaptorPolygon
{
	...
	unsigned char                                      UnknownData_E0BS[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_35Q7[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FMeshElementAttributeData
{
	...
	unsigned char                                      UnknownData_4O67[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPolygonGroupToCreate
{
	...
	unsigned char                                      UnknownData_23FJ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CGBX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_63WX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttributesForEdge
{
	...
	unsigned char                                      UnknownData_6HGZ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttributesForVertexInstance
{
	...
	unsigned char                                      UnknownData_C4VV[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FVertexID                                   VertexID;                                                  // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ZSPO[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_HZR8[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPolygonToCreate
{
	...
	unsigned char                                      UnknownData_SPQC[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_93WQ[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FEdgeToCreate
{
	...
	unsigned char                                      UnknownData_7485[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FVertexID                                   VertexID;                                                  // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_8R3W[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMeshElementAttributeList                   VertexInstanceAttributes;                                  // 0x0008(0x0010) (BlueprintVisible, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_Q29V[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FVertexToCreate
{
	...
	unsigned char                                      UnknownData_Z14A[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSubdividedWireEdge
{
	...
	unsigned char                                      UnknownData_YDER[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FRenderingPolygonGroup
{
	...
	int                                                MaterialIndex;                                             // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                MaxTriangles;                                              // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_MUYC[0x3C];                                    // 0x000C(0x003C) MISSED OFFSET (PADDING)
...
{
	struct FPolygonGroupID                             PolygonGroupID;                                            // 0x0000(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_V01I[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
