...
struct FEngineServicePong
{
	...
	unsigned char                                      UnknownData_114N[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_84DR[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GM4M[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
