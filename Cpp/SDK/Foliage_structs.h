...
struct FFoliageVertexColorChannelMask
{
	...
	unsigned char                                      UnknownData_QZZ5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BZYS[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FFoliageTypeObject
{
	...
	unsigned char                                      UnknownData_8N5D[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FProceduralFoliageInstance
{
	...
	unsigned char                                      UnknownData_JUYJ[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (PADDING)
