...
struct FGameplayTagQuery
{
	...
	unsigned char                                      UnknownData_OYWN[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayTagSource
{
	...
	unsigned char                                      UnknownData_6IFQ[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRestrictedGameplayTagTableRow : public FGameplayTagTableRow
{
	...
	unsigned char                                      UnknownData_9JBQ[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BBWW[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QVEF[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_003I[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
