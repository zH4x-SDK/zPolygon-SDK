...
struct FChaosCollisionEventRequestSettings
{
	...
	unsigned char                                      UnknownData_BFTH[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FChaosBreakingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_JZCK[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FChaosTrailingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_T0M2[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FGeomComponentCacheParameters
{
	...
	unsigned char                                      UnknownData_S5OH[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IQVN[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YGK4[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3CLZ[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_95DC[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_150Y[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T4AC[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5E8W[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TGWM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FGeometryCollectionDebugDrawActorSelectedRigidBody
{
	...
	unsigned char                                      UnknownData_0A20[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGeometryCollectionSource
{
	...
	unsigned char                                      UnknownData_YAM0[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGeometryCollectionSizeSpecificData
{
	...
	unsigned char                                      UnknownData_32I9[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChaosCollisionEventData
{
	...
	unsigned char                                      UnknownData_NHRH[0x14];                                    // 0x0044(0x0014) MISSED OFFSET (PADDING)
