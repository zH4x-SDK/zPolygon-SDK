...
{
	unsigned char                                      UnknownData_M804[0xAC];                                    // 0x0000(0x00AC) MISSED OFFSET (PADDING)
...
struct FBehaviorInfo
{
	...
	unsigned char                                      UnknownData_QRSW[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FActiveGizmo
{
	unsigned char                                      UnknownData_TKMU[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FInputRayHit
{
	unsigned char                                      UnknownData_TKF0[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
