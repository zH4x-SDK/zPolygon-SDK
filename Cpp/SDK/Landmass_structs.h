...
struct FBrushEffectBlurring
{
	...
	unsigned char                                      UnknownData_OZRB[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLandmassBrushEffectsList
{
	...
	unsigned char                                      UnknownData_U4A4[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FBrushEffectCurves
{
	...
	unsigned char                                      UnknownData_1I5D[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GK36[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FLandmassFalloffSettings
{
	...
	unsigned char                                      UnknownData_SV51[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLandmassTerrainCarvingSettings
{
	...
	unsigned char                                      UnknownData_WDLI[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UCMJ[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
