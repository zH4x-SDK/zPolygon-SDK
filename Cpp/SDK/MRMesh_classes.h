...
public:
	...
	unsigned char                                      UnknownData_4149[0x4];                                     // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ROHK[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8DXC[0x20];                                    // 0x0250(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SAL7[0x10];                                    // 0x0440(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DIGD[0x5];                                     // 0x0463(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XX9L[0x80];                                    // 0x0480(0x0080) MISSED OFFSET (PADDING)
