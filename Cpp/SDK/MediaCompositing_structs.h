...
struct FMovieSceneMediaPlayerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_8ZJG[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneMediaSectionParams
{
	...
	unsigned char                                      UnknownData_RF6W[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
