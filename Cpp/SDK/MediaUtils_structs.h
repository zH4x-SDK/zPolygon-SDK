...
struct FMediaPlayerOptions
{
	...
	unsigned char                                      UnknownData_1WRM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_57HL[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (PADDING)
