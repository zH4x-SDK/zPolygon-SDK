...
{
public:
	unsigned char                                      UnknownData_TDTF[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UQKC[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_D657[0x28];                                    // 0x0068(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0CBO[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KXKR[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ACY1[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XHCQ[0x20];                                    // 0x00A0(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4UHE[0x10];                                    // 0x0058(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IYIK[0x70];                                    // 0x0068(0x0070) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DULA[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0O9Z[0xE];                                     // 0x00DA(0x000E) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GZ0O[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_60JS[0x6];                                     // 0x00EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0VUC[0x110];                                   // 0x0110(0x0110) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4WNM[0xB];                                     // 0x0221(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_95QQ[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CKSM[0x78];                                    // 0x0060(0x0078) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_12GG[0x2];                                     // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_BZAR[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_54D1[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
