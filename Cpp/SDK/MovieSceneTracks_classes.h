...
public:
	...
	unsigned char                                      UnknownData_JG93[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_5ROK[0x8];                                     // 0x0110(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CQAC[0x2];                                     // 0x012E(0x0002) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_IBZ8[0x2];                                     // 0x01B2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FTQR[0x3];                                     // 0x01B5(0x0003) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TLOP[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4NM2[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BLRT[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneTransformMask                    TransformMask;                                             // 0x00F0(0x0004) (NoDestructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_VRJC[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B66S[0x7];                                     // 0x0739(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZDLA[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NQW4[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_64DB[0x5];                                     // 0x02FB(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_FQ2Q[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_6GTY[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_69QN[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_E1RO[0x7];                                     // 0x0121(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KX6E[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_Y2GI[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7Y36[0x3];                                     // 0x00F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BVAW[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LO9F[0xF];                                     // 0x0151(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YEE1[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_06N3[0x68];                                    // 0x0050(0x0068) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OVII[0x3];                                     // 0x0115(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EO0T[0x4];                                     // 0x0124(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_I1ED[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_Z5AQ[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_2ZQT[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UMovieSceneSection*>                  CameraShakeSections;                                       // 0x0080(0x0010) (ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
{
public:
	unsigned char                                      UnknownData_YCRM[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0DB8[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IPCI[0x180];                                   // 0x0040(0x0180) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LU4W[0x1E0];                                   // 0x0040(0x01E0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ULC9[0x180];                                   // 0x0040(0x0180) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8133[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UEnum*                                       Enum;                                                      // 0x00B0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	unsigned char                                      UnknownData_1E7J[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0M2I[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FKMH[0x250];                                   // 0x0040(0x0250) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_U2DB[0x3];                                     // 0x01DD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OVMT[0x3];                                     // 0x0201(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1Q54[0x47];                                    // 0x0229(0x0047) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ITWF[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IQEX[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N0HW[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3TQ0[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8GKK[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MHRC[0x38];                                    // 0x0040(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CU2U[0x4];                                     // 0x036C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6NXC[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DWW0[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_S1X3[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_507K[0x38];                                    // 0x0040(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_B7FO[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_2PW6[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_50WI[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JOW5[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0FMZ[0x3];                                     // 0x0085(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_ONIC[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_AD3E[0x7];                                     // 0x0199(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PZWR[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_L69C[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_50MM[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9GAO[0x1A8];                                   // 0x0040(0x01A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YYYW[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WJNF[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_K1QM[0x168];                                   // 0x0040(0x0168) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_F3PT[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_WEM8[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JARE[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LRHU[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_AXLA[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UMovieSceneSection*>                  Sections;                                                  // 0x0080(0x0010) (ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
{
public:
	unsigned char                                      UnknownData_AAZH[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_856O[0xC0];                                    // 0x0060(0x00C0) MISSED OFFSET (PADDING)
