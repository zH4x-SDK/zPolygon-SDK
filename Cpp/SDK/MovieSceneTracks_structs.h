...
struct FMovieSceneActorReferenceData : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_XCIF[0x28];                                    // 0x0018(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FMovieSceneActorReferenceKey>        KeyValues;                                                 // 0x0040(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_6BI7[0x60];                                    // 0x0050(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraAnimSectionData
{
	...
	unsigned char                                      UnknownData_64GA[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSectionData
{
	...
	unsigned char                                      UnknownData_B5G3[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CZHD[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSourceTrigger
{
	...
	unsigned char                                      UnknownData_7ZS3[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_92GC[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSourceTriggerChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_928H[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CCET[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FMovieSceneStringChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_AU4R[0x67];                                    // 0x0039(0x0067) MISSED OFFSET (PADDING)
...
struct FMovieScene3DPathSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_FOQX[0x2];                                     // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_62OC[0x3];                                     // 0x00DD(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieScene3DTransformKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_WS3K[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DScaleKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_E2EE[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DRotationKeyStruct : public FMovieSceneKeyStruct
{
	...
	struct FFrameNumber                                Time;                                                      // 0x0014(0x0004) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_YFTY[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DLocationKeyStruct : public FMovieSceneKeyStruct
{
	struct FVector                                     Location;                                                  // 0x0008(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                                Time;                                                      // 0x0014(0x0004) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_6SDL[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DTransformTemplateData
{
	...
	unsigned char                                      UnknownData_N51X[0x3];                                     // 0x0641(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UFB2[0x7];                                     // 0x0649(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSectionTemplate : public FMovieSceneAdditiveCameraAnimationTemplate
{
	...
	unsigned char                                      UnknownData_XM2I[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraAnimSectionTemplate : public FMovieSceneAdditiveCameraAnimationTemplate
{
	...
	struct FFrameNumber                                SectionStartTime;                                          // 0x0040(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_SUI1[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneColorKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_ZVOL[0x1C];                                    // 0x001C(0x001C) MISSED OFFSET (PADDING)
...
struct FMovieSceneColorSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_R4X7[0x7];                                     // 0x02B9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventTriggerData
{
	...
	unsigned char                                      UnknownData_ZEVB[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SK3P[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventSectionData : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_UKAP[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_5CES[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneFadeSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_VRDD[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneComponentMaterialSectionTemplate : public FMovieSceneParameterSectionTemplate
{
	...
	unsigned char                                      UnknownData_2JVN[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieScenePrimitiveMaterialTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_1SQT[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneVectorPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_UNOS[0x3];                                     // 0x02BD(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneIntegerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_VJ8F[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneSkeletalAnimationParams
{
	...
	unsigned char                                      UnknownData_HRBX[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TYHP[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RW3C[0x2];                                     // 0x00CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MU8G[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneVectorKeyStructBase : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_9I8C[0x1C];                                    // 0x000C(0x001C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T7BE[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneVectorKeyStruct : public FMovieSceneVectorKeyStructBase
{
	...
	unsigned char                                      UnknownData_TNWZ[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_4EE5[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
