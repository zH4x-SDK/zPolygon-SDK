...
public:
	...
	unsigned char                                      UnknownData_MXWJ[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J02Z[0x1];                                     // 0x0054(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T5XR[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_DPFU[0xB0];                                    // 0x0028(0x00B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2CSN[0x18];                                    // 0x0218(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HE2Z[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WZ61[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_D67O[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_SOBN[0x210];                                   // 0x0028(0x0210) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneEntitySystemGraph                SystemGraph;                                               // 0x0238(0x0138) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_JZM0[0xE8];                                    // 0x0370(0x00E8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TS2Q[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z7SJ[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8THO[0x10];                                    // 0x0060(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_T369[0x90];                                    // 0x0040(0x0090) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XM6W[0x6];                                     // 0x0052(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3MSX[0x3];                                     // 0x00B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0932[0x3];                                     // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BLR6[0x1D];                                    // 0x00CB(0x001D) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KFE2[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_E545[0x8];                                     // 0x0180(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AFTW[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1YWE[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_9AE6[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LNXL[0x4];                                     // 0x013C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_H1Z5[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_2G7P[0xB0];                                    // 0x0040(0x00B0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q5JV[0x3E8];                                   // 0x0028(0x03E8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SMXT[0x3];                                     // 0x0461(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W2UJ[0x3];                                     // 0x0465(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_57U2[0x4];                                     // 0x0494(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZE0M[0x68];                                    // 0x0580(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TScriptInterface<class UMovieScenePlaybackClient>  PlaybackClient;                                            // 0x05F8(0x0010) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	unsigned char                                      UnknownData_ZJEF[0x70];                                    // 0x0610(0x0070) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Q1UR[0x6];                                     // 0x011A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_WBIK[0x58];                                    // 0x0038(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K8RV[0x20];                                    // 0x0040(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JPYT[0x5];                                     // 0x03F3(0x0005) MISSED OFFSET (PADDING)
