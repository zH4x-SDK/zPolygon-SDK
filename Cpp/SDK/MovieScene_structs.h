...
struct FMovieSceneTrackEvalOptions
{
	...
	unsigned char                                      UnknownData_BQNJ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneTrackEvaluationFieldEntry
{
	...
	unsigned char                                      UnknownData_FJCF[0x1];                                     // 0x001D(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneEasingSettings
{
	...
	unsigned char                                      UnknownData_68I9[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R2QR[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_F9F0[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Z8B7[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_88EZ[0x80];                                    // 0x0000(0x0080) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneEntitySystemGraphNodes           Nodes;                                                     // 0x0080(0x0038) (NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_CBZF[0x80];                                    // 0x00B8(0x0080) MISSED OFFSET (PADDING)
...
{
	class UMovieSceneSection*                          Section;                                                   // 0x0000(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_A5W4[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8ZJN[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvalTemplate : public FMovieSceneEvalTemplateBase
{
	...
	unsigned char                                      UnknownData_VFNQ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_42TW[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneTangentData
{
	...
	unsigned char                                      UnknownData_7CAM[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatValue
{
	...
	unsigned char                                      UnknownData_9PZD[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SSV7[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_7LY0[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_050O[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneIntegerChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_X6X5[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        Values;                                                    // 0x0020(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_2VGP[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
struct FTrackInstanceInputComponent
{
	...
	unsigned char                                      UnknownData_G0K8[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieScenePropertyBinding
{
	...
	unsigned char                                      UnknownData_PTBC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneByteChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_FLR5[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IN2J[0x60];                                    // 0x0038(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MLZG[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_XG7T[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FMovieSceneSubSectionData
{
	...
	unsigned char                                      UnknownData_GVST[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_44EM[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneKeyTimeStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_RRHO[0x1C];                                    // 0x000C(0x001C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_P5VP[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FMovieSceneObjectPathChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_9Z5L[0x60];                                    // 0x0060(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XQXT[0x58];                                    // 0x0000(0x0058) MISSED OFFSET (PADDING)
...
struct FSectionEvaluationData
{
	...
	unsigned char                                      UnknownData_LGSC[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AKQZ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_U9FC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneSequencePlaybackParams
{
	...
	unsigned char                                      UnknownData_HSWI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RYZD[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (PADDING)
...
struct FMovieSceneTrackDisplayOptions
{
	...
	unsigned char                                      UnknownData_SQLI[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneSequenceReplProperties
{
	...
	unsigned char                                      UnknownData_LB0Q[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarkedFrame
{
	...
	unsigned char                                      UnknownData_MX5T[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneTemplateGenerationLedger
{
	...
	unsigned char                                      UnknownData_HLIM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_C52A[0x88];                                    // 0x0000(0x0088) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QH8X[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvaluationTrack
{
	...
	unsigned char                                      UnknownData_B231[0x1];                                     // 0x0013(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HA92[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W5FZ[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvaluationTemplate
{
	...
	unsigned char                                      UnknownData_M9F7[0x50];                                    // 0x0050(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BBJH[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSequencePlaybackSettings
{
	...
	unsigned char                                      UnknownData_Q76G[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7ZPW[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneRootEvaluationTemplateInstance
{
	...
	unsigned char                                      UnknownData_MZG0[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z58G[0x70];                                    // 0x0020(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FMovieSceneSequenceID, class UObject*> DirectorInstances;                                         // 0x0090(0x0050) (NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_X88H[0x8];                                     // 0x00E0(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneSectionParameters
{
	...
	unsigned char                                      UnknownData_KRM2[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSpawnable
{
	...
	unsigned char                                      UnknownData_V1DI[0x2];                                     // 0x0042(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FKJE[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UKZO[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JC3W[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneObjectBindingID
{
	...
	unsigned char                                      UnknownData_FRP1[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneBindingOverrideData
{
	...
	unsigned char                                      UnknownData_VIA0[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneBoolChannel : public FMovieSceneChannel
{
	...
	bool                                               bHasDefaultValue;                                          // 0x0019(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_3NLL[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<bool>                                       Values;                                                    // 0x0020(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_6I97[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GANR[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JXWL[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YQJR[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneFieldEntry_EvaluationTrack
{
	...
	unsigned char                                      UnknownData_C1Z8[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FMovieSceneFieldEntry_ChildTemplate
{
	...
	unsigned char                                      UnknownData_A080[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FFrameNumber                                ForcedTime;                                                // 0x0004(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FMovieSceneSequenceHierarchyNode
{
	...
	unsigned char                                      UnknownData_A3XM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FMovieSceneTimeTransform                    LinearTransform;                                           // 0x0000(0x000C) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WNJG[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSubSequenceData
{
	...
	unsigned char                                      UnknownData_5J8G[0x1];                                     // 0x0097(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneSequenceInstanceDataPtr          InstanceData;                                              // 0x0098(0x0018) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CK9M[0x8];                                     // 0x00B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneEvaluationFieldEntityMetaData
{
	...
	unsigned char                                      UnknownData_WY9M[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	MovieScene_ESectionEvaluationFlags                 Flags;                                                     // 0x0008(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_NY99[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
