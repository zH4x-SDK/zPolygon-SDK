...
struct FSupportedAreaData
{
	...
	unsigned char                                      UnknownData_ZXD7[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNavGraphNode
{
	...
	unsigned char                                      UnknownData_RB6L[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FNavigationFilterArea
{
	...
	unsigned char                                      UnknownData_6GF9[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FNavigationFilterFlags
{
	...
	unsigned char                                      UnknownData_3GTO[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KAVH[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FNavLinkCustomInstanceData : public FActorComponentInstanceData
{
	...
	unsigned char                                      UnknownData_1JKM[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
struct FRecastNavMeshGenerationProperties
{
	...
	unsigned char                                      UnknownData_B8VT[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3I80[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
