...
struct FSimulationStageMetaData
{
	...
	unsigned char                                      UnknownData_SAFT[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_NSL1[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FNiagaraCompileEvent
{
	...
	unsigned char                                      UnknownData_35A2[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
