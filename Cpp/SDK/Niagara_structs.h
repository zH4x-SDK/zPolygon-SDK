...
{
	unsigned char                                      UnknownData_PSNU[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraMaterialOverride
{
	...
	unsigned char                                      UnknownData_IUJ0[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraTypeDefinition
{
	...
	unsigned char                                      UnknownData_QQ7J[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FNiagaraScriptDataInterfaceCompileInfo
{
	...
	unsigned char                                      UnknownData_HBNJ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z6M9[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterHandle
{
	...
	unsigned char                                      UnknownData_L19J[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6CES[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_J1KX[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_608B[0x28];                                    // 0x0050(0x0028) MISSED OFFSET (PADDING)
...
struct FNCPoolElement
{
	...
	unsigned char                                      UnknownData_DZNN[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FNCPool
{
	...
	unsigned char                                      UnknownData_GON0[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraPlatformSetCVarCondition
{
	...
	unsigned char                                      UnknownData_FIRY[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q7WD[0xB];                                     // 0x001D(0x000B) MISSED OFFSET (PADDING)
...
struct FNiagaraPlatformSet
{
	...
	unsigned char                                      UnknownData_ENA8[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9NRE[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraVariableAttributeBinding
{
	...
	unsigned char                                      UnknownData_EXZK[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L32Q[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QPYN[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraComponentPropertyBinding
{
	...
	unsigned char                                      UnknownData_IBUP[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (PADDING)
...
struct FVMExternalFunctionBindingInfo
{
	...
	unsigned char                                      UnknownData_FBB4[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraSystemScalabilitySettings
{
	...
	unsigned char                                      UnknownData_2TZ0[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q131[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FNiagaraDataSetID
{
	...
	unsigned char                                      UnknownData_9V4L[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraDataSetProperties
{
	...
	unsigned char                                      UnknownData_87B7[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraVMExecutableData
{
	...
	unsigned char                                      UnknownData_0EUM[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5P1U[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QITZ[0x7];                                     // 0x00C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_38XJ[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterScalabilitySettings
{
	...
	unsigned char                                      UnknownData_WLVS[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraVariableLayoutInfo
{
	...
	unsigned char                                      UnknownData_D5QI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraDataSetCompiledData
{
	...
	unsigned char                                      UnknownData_G8CT[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4DCM[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterScalabilityOverride : public FNiagaraEmitterScalabilitySettings
{
	...
	unsigned char                                      UnknownData_PYN2[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraEventGeneratorProperties
{
	...
	unsigned char                                      UnknownData_98H0[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraEventScriptProperties : public FNiagaraEmitterScriptProperties
{
	...
	unsigned char                                      UnknownData_EXJO[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B3LF[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YFNN[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FNiagaraRibbonUVSettings
{
	...
	unsigned char                                      UnknownData_B03Q[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_QGEA[0x3];                                     // 0x0004(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_RHQ1[0x3];                                     // 0x0008(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_Y2XB[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (PADDING)
...
struct FNiagaraScriptDataInterfaceInfo
{
	...
	unsigned char                                      UnknownData_SJ7E[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraSystemScalabilityOverride : public FNiagaraSystemScalabilitySettings
{
	...
	unsigned char                                      UnknownData_TCMP[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneNiagaraSystemTrackImplementation : public FMovieSceneTrackImplementation
{
	...
	unsigned char                                      UnknownData_Q8ZU[0x3];                                     // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_XRFO[0x3];                                     // 0x001C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_CNFM[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_NQ3L[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneNiagaraVectorParameterSectionTemplate : public FMovieSceneNiagaraParameterSectionTemplate
{
	...
	unsigned char                                      UnknownData_PPGJ[0x4];                                     // 0x02C4(0x0004) MISSED OFFSET (PADDING)
...
struct FNiagaraSystemUpdateContext
{
	...
	unsigned char                                      UnknownData_K58E[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraFunctionSignature
{
	...
	unsigned char                                      UnknownData_E20G[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraGraphViewSettings
{
	...
	unsigned char                                      UnknownData_PZRE[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraScalabilityManager
{
	...
	unsigned char                                      UnknownData_LSNX[0x28];                                    // 0x0018(0x0028) MISSED OFFSET (PADDING)
...
struct FNiagaraModuleDependency
{
	...
	unsigned char                                      UnknownData_N86R[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_RIWP[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VAZ3[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UObject*>                             RootObjects;                                               // 0x0008(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_4GO1[0x68];                                    // 0x0018(0x0068) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TGUO[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FNiagaraVariableMetaData
{
	...
	unsigned char                                      UnknownData_ACDD[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7G5L[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_45AS[0x3];                                     // 0x00D0(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_UO95[0x3];                                     // 0x00D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CLHH[0x2];                                     // 0x00DE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z0IX[0x6];                                     // 0x00EA(0x0006) MISSED OFFSET (PADDING)
...
struct FNiagaraParameterScopeInfo
{
	...
	unsigned char                                      UnknownData_04NB[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_A8WR[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_NTRC[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FGWK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FNiagaraVariant
{
	...
	unsigned char                                      UnknownData_4WFT[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_QH09[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1L06[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraScriptExecutionParameterStore : public FNiagaraParameterStore
{
	...
	unsigned char                                      UnknownData_CF7Y[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraVMExecutableDataId
{
	...
	unsigned char                                      UnknownData_C5KF[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FKL1[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
