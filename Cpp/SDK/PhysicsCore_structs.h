...
{
	unsigned char                                      UnknownData_YON5[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CQIO[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
