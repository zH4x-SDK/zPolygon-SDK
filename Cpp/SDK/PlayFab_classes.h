...
public:
	...
	unsigned char                                      UnknownData_IGCD[0x798];                                   // 0x0040(0x0798) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1CLR[0x50];                                    // 0x07F0(0x0050) MISSED OFFSET (PADDING)
	...
	class UPlayFabAdminAPI* STATIC_UpdateSegment(const struct FAdminUpdateSegmentRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabAdminAPI* STATIC_SetTitleDataAndOverrides(const struct FAdminSetTitleDataAndOverridesRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabAdminAPI* STATIC_GetSegments(const struct FAdminGetSegmentsRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabAdminAPI* STATIC_DeleteTitleDataOverride(const struct FAdminDeleteTitleDataOverrideRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabAdminAPI* STATIC_DeleteSegment(const struct FAdminDeleteSegmentRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabAdminAPI* STATIC_CreateSegment(const struct FAdminCreateSegmentRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabAdminAPI* STATIC_CreateInsightsScheduledScalingTask(const struct FAdminCreateInsightsScheduledScalingTaskRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
...
public:
	...
	struct FAdminUpdateSegmentResponse STATIC_decodeUpdateSegmentResponseResponse(class UPlayFabJsonObject* response);
	...
	struct FAdminSetTitleDataAndOverridesResult STATIC_decodeSetTitleDataAndOverridesResultResponse(class UPlayFabJsonObject* response);
	...
	struct FAdminGetSegmentsResponse STATIC_decodeGetSegmentsResponseResponse(class UPlayFabJsonObject* response);
	...
	struct FAdminDeleteTitleDataOverrideResult STATIC_decodeDeleteTitleDataOverrideResultResponse(class UPlayFabJsonObject* response);
	struct FAdminDeleteStoreResult STATIC_decodeDeleteStoreResultResponse(class UPlayFabJsonObject* response);
	struct FAdminDeleteSegmentsResponse STATIC_decodeDeleteSegmentsResponseResponse(class UPlayFabJsonObject* response);
	...
	struct FAdminCreateSegmentResponse STATIC_decodeCreateSegmentResponseResponse(class UPlayFabJsonObject* response);
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QXUZ[0x68];                                    // 0x0040(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AUHJ[0x50];                                    // 0x00C0(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_6N97[0xAB8];                                   // 0x0040(0x0AB8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GNB5[0x50];                                    // 0x0B10(0x0050) MISSED OFFSET (PADDING)
	...
	class UPlayFabClientAPI* STATIC_UnlinkOpenIdConnect(const struct FClientUnlinkOpenIdConnectRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabClientAPI* STATIC_UnlinkNintendoServiceAccount(const struct FClientUnlinkNintendoServiceAccountRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabClientAPI* STATIC_UnlinkApple(const struct FClientUnlinkAppleRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabClientAPI* STATIC_RewardAdActivity(const struct FClientRewardAdActivityRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabClientAPI* STATIC_ReportAdActivity(const struct FClientReportAdActivityRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabClientAPI* STATIC_LoginWithNintendoServiceAccount(const struct FClientLoginWithNintendoServiceAccountRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabClientAPI* STATIC_LoginWithApple(const struct FClientLoginWithAppleRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabClientAPI* STATIC_LinkNintendoServiceAccount(const struct FClientLinkNintendoServiceAccountRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabClientAPI* STATIC_LinkApple(const struct FClientLinkAppleRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabClientAPI* STATIC_GetAdPlacements(const struct FClientGetAdPlacementsRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabClientAPI* STATIC_ConsumePS5Entitlements(const struct FClientConsumePS5EntitlementsRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabClientAPI* STATIC_ConsumeMicrosoftStoreEntitlements(const struct FClientConsumeMicrosoftStoreEntitlementsRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
...
public:
	...
	struct FClientRewardAdActivityResult STATIC_decodeRewardAdActivityResultResponse(class UPlayFabJsonObject* response);
	...
	struct FClientReportAdActivityResult STATIC_decodeReportAdActivityResultResponse(class UPlayFabJsonObject* response);
	...
	struct FClientGetAdPlacementsResult STATIC_decodeGetAdPlacementsResultResponse(class UPlayFabJsonObject* response);
	...
	struct FClientConsumePS5EntitlementsResult STATIC_decodeConsumePS5EntitlementsResultResponse(class UPlayFabJsonObject* response);
	struct FClientConsumeMicrosoftStoreEntitlementsResponse STATIC_decodeConsumeMicrosoftStoreEntitlementsResponseResponse(class UPlayFabJsonObject* response);
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_Q2FB[0x118];                                   // 0x0040(0x0118) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MCF4[0x50];                                    // 0x0170(0x0050) MISSED OFFSET (PADDING)
	...
	class UPlayFabCloudScriptAPI* STATIC_UnregisterFunction(const struct FCloudScriptUnregisterFunctionRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabCloudScriptAPI* STATIC_RegisterQueuedFunction(const struct FCloudScriptRegisterQueuedFunctionRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabCloudScriptAPI* STATIC_RegisterHttpFunction(const struct FCloudScriptRegisterHttpFunctionRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabCloudScriptAPI* STATIC_PostFunctionResultForScheduledTask(const struct FCloudScriptPostFunctionResultForScheduledTaskRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabCloudScriptAPI* STATIC_PostFunctionResultForPlayerTriggeredAction(const struct FCloudScriptPostFunctionResultForPlayerTriggeredActionRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabCloudScriptAPI* STATIC_PostFunctionResultForFunctionExecution(const struct FCloudScriptPostFunctionResultForFunctionExecutionRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabCloudScriptAPI* STATIC_PostFunctionResultForEntityTriggeredAction(const struct FCloudScriptPostFunctionResultForEntityTriggeredActionRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabCloudScriptAPI* STATIC_ListQueuedFunctions(const struct FCloudScriptListFunctionsRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabCloudScriptAPI* STATIC_ListHttpFunctions(const struct FCloudScriptListFunctionsRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabCloudScriptAPI* STATIC_ListFunctions(const struct FCloudScriptListFunctionsRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabCloudScriptAPI* STATIC_ExecuteFunction(const struct FCloudScriptExecuteFunctionRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
...
public:
	...
	struct FCloudScriptListQueuedFunctionsResult STATIC_decodeListQueuedFunctionsResultResponse(class UPlayFabJsonObject* response);
	struct FCloudScriptListHttpFunctionsResult STATIC_decodeListHttpFunctionsResultResponse(class UPlayFabJsonObject* response);
	struct FCloudScriptListFunctionsResult STATIC_decodeListFunctionsResultResponse(class UPlayFabJsonObject* response);
	struct FCloudScriptExecuteFunctionResult STATIC_decodeExecuteFunctionResultResponse(class UPlayFabJsonObject* response);
	...
	struct FCloudScriptEmptyResult STATIC_decodeEmptyResultResponse(class UPlayFabJsonObject* response);
};
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_YYQ9[0xB8];                                    // 0x0040(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GJ0O[0x50];                                    // 0x0110(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_YME4[0x68];                                    // 0x0040(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x00A8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x00B0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x00B8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_Q5BN[0x50];                                    // 0x00C0(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_I2QB[0x118];                                   // 0x0040(0x0118) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x0158(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x0160(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x0168(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_AE20[0x50];                                    // 0x0170(0x0050) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class PlayFab.PlayFabExperimentationAPI");
		return ptr;
	}



	class UPlayFabExperimentationAPI* STATIC_UpdateExperiment(const struct FExperimentationUpdateExperimentRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabExperimentationAPI* STATIC_UpdateExclusionGroup(const struct FExperimentationUpdateExclusionGroupRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabExperimentationAPI* STATIC_StopExperiment(const struct FExperimentationStopExperimentRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabExperimentationAPI* STATIC_StartExperiment(const struct FExperimentationStartExperimentRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabExperimentationAPI* STATIC_GetTreatmentAssignment(const struct FExperimentationGetTreatmentAssignmentRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabExperimentationAPI* STATIC_GetLatestScorecard(const struct FExperimentationGetLatestScorecardRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabExperimentationAPI* STATIC_GetExperiments(const struct FExperimentationGetExperimentsRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabExperimentationAPI* STATIC_GetExclusionGroupTraffic(const struct FExperimentationGetExclusionGroupTrafficRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabExperimentationAPI* STATIC_GetExclusionGroups(const struct FExperimentationGetExclusionGroupsRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabExperimentationAPI* STATIC_DeleteExperiment(const struct FExperimentationDeleteExperimentRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabExperimentationAPI* STATIC_DeleteExclusionGroup(const struct FExperimentationDeleteExclusionGroupRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	void DelegateOnFailurePlayFabError__DelegateSignature(const struct FPlayFabError& Error, class UObject* customData);
	class UPlayFabExperimentationAPI* STATIC_CreateExperiment(const struct FExperimentationCreateExperimentRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabExperimentationAPI* STATIC_CreateExclusionGroup(const struct FExperimentationCreateExclusionGroupRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
};
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class PlayFab.PlayFabExperimentationModelDecoder");
		return ptr;
	}



	struct FExperimentationGetTreatmentAssignmentResult STATIC_decodeGetTreatmentAssignmentResultResponse(class UPlayFabJsonObject* response);
	struct FExperimentationGetLatestScorecardResult STATIC_decodeGetLatestScorecardResultResponse(class UPlayFabJsonObject* response);
	struct FExperimentationGetExperimentsResult STATIC_decodeGetExperimentsResultResponse(class UPlayFabJsonObject* response);
	struct FExperimentationGetExclusionGroupTrafficResult STATIC_decodeGetExclusionGroupTrafficResultResponse(class UPlayFabJsonObject* response);
	struct FExperimentationGetExclusionGroupsResult STATIC_decodeGetExclusionGroupsResultResponse(class UPlayFabJsonObject* response);
	struct FExperimentationEmptyResponse STATIC_decodeEmptyResponseResponse(class UPlayFabJsonObject* response);
	struct FExperimentationCreateExperimentResult STATIC_decodeCreateExperimentResultResponse(class UPlayFabJsonObject* response);
	struct FExperimentationCreateExclusionGroupResult STATIC_decodeCreateExclusionGroupResultResponse(class UPlayFabJsonObject* response);
};
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_26MC[0x1D8];                                   // 0x0040(0x01D8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TT90[0x50];                                    // 0x0230(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_GXSN[0xA8];                                    // 0x0040(0x00A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W1TA[0x50];                                    // 0x0100(0x0050) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class PlayFab.PlayFabInsightsAPI");
		return ptr;
	}



	class UPlayFabInsightsAPI* STATIC_SetStorageRetention(const struct FInsightsInsightsSetStorageRetentionRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabInsightsAPI* STATIC_SetPerformance(const struct FInsightsInsightsSetPerformanceRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabInsightsAPI* STATIC_GetPendingOperations(const struct FInsightsInsightsGetPendingOperationsRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabInsightsAPI* STATIC_GetOperationStatus(const struct FInsightsInsightsGetOperationStatusRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabInsightsAPI* STATIC_GetLimits(const struct FInsightsInsightsEmptyRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabInsightsAPI* STATIC_GetDetails(const struct FInsightsInsightsEmptyRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class PlayFab.PlayFabInsightsModelDecoder");
		return ptr;
	}



	struct FInsightsInsightsOperationResponse STATIC_decodeInsightsOperationResponseResponse(class UPlayFabJsonObject* response);
	struct FInsightsInsightsGetPendingOperationsResponse STATIC_decodeInsightsGetPendingOperationsResponseResponse(class UPlayFabJsonObject* response);
	struct FInsightsInsightsGetOperationStatusResponse STATIC_decodeInsightsGetOperationStatusResponseResponse(class UPlayFabJsonObject* response);
	struct FInsightsInsightsGetLimitsResponse STATIC_decodeInsightsGetLimitsResponseResponse(class UPlayFabJsonObject* response);
	struct FInsightsInsightsGetDetailsResponse STATIC_decodeInsightsGetDetailsResponseResponse(class UPlayFabJsonObject* response);
};
...
{
public:
	unsigned char                                      UnknownData_MT0T[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XQ9S[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_UZGR[0x58];                                    // 0x0040(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7N30[0x50];                                    // 0x00B0(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QZ84[0x98];                                    // 0x0040(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5G2P[0x50];                                    // 0x00F0(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_N4MY[0x408];                                   // 0x0040(0x0408) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x0448(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x0450(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x0458(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_MOW0[0x50];                                    // 0x0460(0x0050) MISSED OFFSET (PADDING)
	...
	class UPlayFabMultiplayerAPI* STATIC_UpdateBuildRegion(const struct FMultiplayerUpdateBuildRegionRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabMultiplayerAPI* STATIC_UpdateBuildName(const struct FMultiplayerUpdateBuildNameRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_ListTitleMultiplayerServersQuotaChanges(const struct FMultiplayerListTitleMultiplayerServersQuotaChangesRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_ListBuildSummariesV2(const struct FMultiplayerListBuildSummariesRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	class UPlayFabMultiplayerAPI* STATIC_ListBuildAliases(const struct FMultiplayerListBuildAliasesRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_GetTitleMultiplayerServersQuotaChange(const struct FMultiplayerGetTitleMultiplayerServersQuotaChangeRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_GetMultiplayerSessionLogsBySessionId(const struct FMultiplayerGetMultiplayerSessionLogsBySessionIdRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_DeleteContainerImageRepository(const struct FMultiplayerDeleteContainerImageRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_DeleteBuildRegion(const struct FMultiplayerDeleteBuildRegionRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	void DelegateOnFailurePlayFabError__DelegateSignature(const struct FPlayFabError& Error, class UObject* customData);
	class UPlayFabMultiplayerAPI* STATIC_CreateTitleMultiplayerServersQuotaChange(const struct FMultiplayerCreateTitleMultiplayerServersQuotaChangeRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_CreateBuildWithProcessBasedServer(const struct FMultiplayerCreateBuildWithProcessBasedServerRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
...
public:
	...
	struct FMultiplayerListTitleMultiplayerServersQuotaChangesResponse STATIC_decodeListTitleMultiplayerServersQuotaChangesResponseResponse(class UPlayFabJsonObject* response);
	...
	struct FMultiplayerListBuildAliasesResponse STATIC_decodeListBuildAliasesResponseResponse(class UPlayFabJsonObject* response);
	...
	struct FMultiplayerGetTitleMultiplayerServersQuotaChangeResponse STATIC_decodeGetTitleMultiplayerServersQuotaChangeResponseResponse(class UPlayFabJsonObject* response);
	...
	struct FMultiplayerCreateTitleMultiplayerServersQuotaChangeResponse STATIC_decodeCreateTitleMultiplayerServersQuotaChangeResponseResponse(class UPlayFabJsonObject* response);
	...
	struct FMultiplayerCreateBuildWithProcessBasedServerResponse STATIC_decodeCreateBuildWithProcessBasedServerResponseResponse(class UPlayFabJsonObject* response);
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_W6HP[0xB8];                                    // 0x0040(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x00F8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x0100(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x0108(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_NBR5[0x50];                                    // 0x0110(0x0050) MISSED OFFSET (PADDING)
...
// 0x0910 (FullSize[0x0940] - InheritedSize[0x0030])
class UPlayFabServerAPI : public UOnlineBlueprintCallProxyBase
{
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3PV1[0x898];                                   // 0x0040(0x0898) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KIY0[0x50];                                    // 0x08F0(0x0050) MISSED OFFSET (PADDING)
	...
	class UPlayFabServerAPI* STATIC_LoginWithSteamId(const struct FServerLoginWithSteamIdRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
...
public:
	...
	void STATIC_setPlayFabSettings(const struct FString& GameTitleId, const struct FString& PlayFabSecretApiKey, const struct FString& ProductionUrl, const struct FString& PhotonRealtimeAppId, const struct FString& PhotonTurnbasedAppId, const struct FString& PhotonChatAppId);
