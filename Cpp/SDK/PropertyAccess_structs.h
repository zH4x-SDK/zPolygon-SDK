...
struct FPropertyAccessSegment
{
	...
	unsigned char                                      UnknownData_32NW[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FPropertyAccessPath
{
	...
	unsigned char                                      UnknownData_9VLK[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FPropertyAccessCopy
{
	...
	unsigned char                                      UnknownData_1I22[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FPropertyAccessIndirectionChain
{
	...
	unsigned char                                      UnknownData_A7SW[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPropertyAccessIndirection
{
	...
	unsigned char                                      UnknownData_ZF3F[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (PADDING)
...
struct FPropertyAccessLibrary
{
	...
	unsigned char                                      UnknownData_8A21[0x18];                                    // 0x00B0(0x0018) MISSED OFFSET (PADDING)
