...
struct FPropertyPathSegment
{
	...
	unsigned char                                      UnknownData_X6BR[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FYLJ[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FCachedPropertyPath
{
	...
	unsigned char                                      UnknownData_EAJO[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DWTZ[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
