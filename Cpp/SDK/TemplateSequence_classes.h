...
{
public:
	unsigned char                                      UnknownData_GDF8[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RVHI[0x3C];                                    // 0x0034(0x003C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4V1Q[0x3];                                     // 0x00B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L71F[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LBLV[0x458];                                   // 0x0028(0x0458) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KW6J[0x60];                                    // 0x0578(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WG4T[0x8];                                     // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DGI3[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PS0D[0x4];                                     // 0x026C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1GFV[0x8];                                     // 0x0680(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ARFC[0x8];                                     // 0x0160(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5N4S[0x70];                                    // 0x0040(0x0070) MISSED OFFSET (PADDING)
