...
public:
	...
	class UImage*                                      Image_183;                                                 // 0x0268(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_GameLoading.UI_GameLoading_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_GameLoading(int EntryPoint);
};
