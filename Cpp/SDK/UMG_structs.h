...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData_6F7W[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YWW4[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_K3JM[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FRadialBoxSettings
{
	...
	unsigned char                                      UnknownData_4RSI[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUserWidgetPool
{
	...
	unsigned char                                      UnknownData_LEYZ[0x60];                                    // 0x0020(0x0060) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_AYS1[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_1GHR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_SYUL[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_M25S[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventReply
{
	unsigned char                                      UnknownData_EEXA[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q52T[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_EA59[0x7];                                     // 0x02B9(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_L28X[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
