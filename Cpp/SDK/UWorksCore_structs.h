...
{
	EUWorksResult__Unknown         = 0,
	EUWorksResult__OK              = 1,
	EUWorksResult__Fail            = 2,
	EUWorksResult__NoConnection    = 3,
	EUWorksResult__InvalidPassword = 4,
	EUWorksResult__LoggedInElsewhere = 5,
	EUWorksResult__InvalidProtocolVer = 6,
	EUWorksResult__InvalidParam    = 7,
	EUWorksResult__FileNotFound    = 8,
	EUWorksResult__Busy            = 9,
	EUWorksResult__InvalidState    = 10,
	EUWorksResult__InvalidName     = 11,
	EUWorksResult__InvalidEmail    = 12,
	EUWorksResult__DuplicateName   = 13,
	EUWorksResult__AccessDenied    = 14,
	EUWorksResult__Timeout         = 15,
	EUWorksResult__Banned          = 16,
	EUWorksResult__AccountNotFound = 17,
	EUWorksResult__InvalidSteamID  = 18,
	EUWorksResult__ServiceUnavailable = 19,
	EUWorksResult__NotLoggedOn     = 20,
	EUWorksResult__Pending         = 21,
	EUWorksResult__EncryptionFailure = 22,
	EUWorksResult__InsufficientPrivilege = 23,
	EUWorksResult__LimitExceeded   = 24,
	EUWorksResult__Revoked         = 25,
	EUWorksResult__Expired         = 26,
	EUWorksResult__AlreadyRedeemed = 27,
	EUWorksResult__DuplicateRequest = 28,
	EUWorksResult__AlreadyOwned    = 29,
	EUWorksResult__IPNotFound      = 30,
	EUWorksResult__PersistFailed   = 31,
	EUWorksResult__LockingFailed   = 32,
	EUWorksResult__LogonSessionReplaced = 33,
	EUWorksResult__ConnectFailed   = 34,
	EUWorksResult__HandshakeFailed = 35,
	EUWorksResult__IOFailure       = 36,
	EUWorksResult__RemoteDisconnect = 37,
	EUWorksResult__ShoppingCartNotFound = 38,
	EUWorksResult__Blocked         = 39,
	EUWorksResult__Ignored         = 40,
	EUWorksResult__NoMatch         = 41,
	EUWorksResult__AccountDisabled = 42,
	EUWorksResult__ServiceReadOnly = 43,
	EUWorksResult__AccountNotFeatured = 44,
	EUWorksResult__AdministratorOK = 45,
	EUWorksResult__ContentVersion  = 46,
	EUWorksResult__TryAnotherCM    = 47,
	EUWorksResult__PasswordRequiredToKickSession = 48,
	EUWorksResult__AlreadyLoggedInElsewhere = 49,
	EUWorksResult__Suspended       = 50,
	EUWorksResult__Cancelled       = 51,
	EUWorksResult__DataCorruption  = 52,
	EUWorksResult__DiskFull        = 53,
	EUWorksResult__RemoteCallFailed = 54,
	EUWorksResult__PasswordUnset   = 55,
	EUWorksResult__ExternalAccountUnlinked = 56,
	EUWorksResult__PSNTicketInvalid = 57,
	EUWorksResult__ExternalAccountAlreadyLinked = 58,
	EUWorksResult__RemoteFileConflict = 59,
	EUWorksResult__IllegalPassword = 60,
	EUWorksResult__SameAsPreviousValue = 61,
	EUWorksResult__AccountLogonDenied = 62,
	EUWorksResult__CannotUseOldPassword = 63,
	EUWorksResult__InvalidLoginAuthCode = 64,
	EUWorksResult__AccountLogonDeniedNoMail = 65,
	EUWorksResult__HardwareNotCapableOfIPT = 66,
	EUWorksResult__IPTInitError    = 67,
	EUWorksResult__ParentalControlRestricted = 68,
	EUWorksResult__FacebookQueryError = 69,
	EUWorksResult__ExpiredLoginAuthCode = 70,
	EUWorksResult__IPLoginRestrictionFailed = 71,
	EUWorksResult__AccountLockedDown = 72,
	EUWorksResult__AccountLogonDeniedVerifiedEmailRequired = 73,
	EUWorksResult__NoMatchingURL   = 74,
	EUWorksResult__BadResponse     = 75,
	EUWorksResult__RequirePasswordReEntry = 76,
	EUWorksResult__ValueOutOfRange = 77,
	EUWorksResult__UnexpectedError = 78,
	EUWorksResult__Disabled        = 79,
	EUWorksResult__InvalidCEGSubmission = 80,
	EUWorksResult__RestrictedDevice = 81,
	EUWorksResult__RegionLocked    = 82,
	EUWorksResult__RateLimitExceeded = 83,
	EUWorksResult__AccountLoginDeniedNeedTwoFactor = 84,
	EUWorksResult__ItemDeleted     = 85,
	EUWorksResult__AccountLoginDeniedThrottle = 86,
	EUWorksResult__TwoFactorCodeMismatch = 87,
	EUWorksResult__TwoFactorActivationCodeMismatch = 88,
	EUWorksResult__AccountAssociatedToMultiplePartners = 89,
	EUWorksResult__NotModified     = 90,
	EUWorksResult__NoMobileDevice  = 91,
	EUWorksResult__TimeNotSynced   = 92,
	EUWorksResult__SmsCodeFailed   = 93,
	EUWorksResult__AccountLimitExceeded = 94,
	EUWorksResult__AccountActivityLimitExceeded = 95,
	EUWorksResult__PhoneActivityLimitExceeded = 96,
	EUWorksResult__RefundToWallet  = 97,
	EUWorksResult__EmailSendFailure = 98,
	EUWorksResult__NotSettled      = 99,
	EUWorksResult__NeedCaptcha     = 100,
	EUWorksResult__GSLTDenied      = 101,
	EUWorksResult__GSOwnerDenied   = 102,
	EUWorksResult__InvalidItemType = 103,
	EUWorksResult__IPBanned        = 104,
	EUWorksResult__GSLTExpired     = 105,
	EUWorksResult__EUWorksResult_MAX = 106,
...
{
	EUWorksChatRoomEnterResponse__Unknown = 0,
	...
	EUWorksChatRoomEnterResponse__EUWorksChatRoomEnterResponse_MAX = 12,
...
{
	EUWorksFavoriteFlags__Unknown  = 0,
	EUWorksFavoriteFlags__Favorite = 1,
	EUWorksFavoriteFlags__History  = 2,
	EUWorksFavoriteFlags__EUWorksFavoriteFlags_MAX = 3,
...
{
	unsigned char                                      UnknownData_SRLN[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
struct FUWorksServerInfo
{
	...
	unsigned char                                      UnknownData_ECT0[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TX51[0x2];                                     // 0x0072(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IWDA[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_EY8X[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8ZHV[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XUPS[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WS1O[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T42Z[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y3GC[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_M5Q6[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Z9ZB[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OZTD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WXIP[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZGO2[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FUWorksControllerAnalogActionData
{
	...
	unsigned char                                      UnknownData_K5TO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6IMK[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QT0T[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FEGO[0x2];                                     // 0x0000(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_L8RM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QAZQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_089M[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SKNO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MLZ1[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9IAP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q6SW[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0ZR5[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_N8JO[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PWIK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7G4H[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MRC3[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FUWorksSteamUGCDetails
{
	...
	unsigned char                                      UnknownData_VLU0[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1B4T[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6DVV[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6FXV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DCB6[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FUWorksLeaderboardEntry
{
	...
	unsigned char                                      UnknownData_6CK3[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_CPCN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7W4I[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0A56[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W8ZI[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
