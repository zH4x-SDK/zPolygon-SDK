...
public:
	...
	{
		static auto ptr = UObject::FindClass("Class UWorksUtilities.UWorksLibrary");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UWorksUtilities.UWorksLibraryConversions");
		return ptr;
	}
	...
	struct FString STATIC_ConvertBytesToHEXString(TArray<unsigned char> Data);
};
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UWorksUtilities.UWorksLibraryGameID");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UWorksUtilities.UWorksLibraryLex");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UWorksUtilities.UWorksLibrarySteamID");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UWorksUtilities.UWorksLibraryTickets");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UWorksUtilities.UWorksManager");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_HB1I[0x58];                                    // 0x0028(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UWorksUtilities.UWorksManagerNetwork");
		return ptr;
	}
