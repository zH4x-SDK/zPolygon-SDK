...
struct FCapturedPropSegment
{
	...
	unsigned char                                      UnknownData_ZO8A[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVariantDependency
{
	...
	unsigned char                                      UnknownData_8OP9[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
