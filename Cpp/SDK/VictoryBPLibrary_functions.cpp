...
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UTKMathFunctionLibrary::STATIC_LineToLineIntersection(struct FVector* IntersectionPoint, const struct FVector& LinePoint1, const struct FVector& LineDir1, const struct FVector& LinePoint2, const struct FVector& LineDir2)
{
...
// float                          ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
float UTKMathFunctionLibrary::STATIC_ConvertPhysicsLinearVelocity(const struct FVector& Velocity, TEnumAsByte<VictoryBPLibrary_ESpeedUnit> SpeedUnit)
{
...
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UTKMathFunctionLibrary::STATIC_ClosestPointsOnTwoLines(struct FVector* closestPointLine1, struct FVector* closestPointLine2, const struct FVector& LinePoint1, const struct FVector& lineVec1, const struct FVector& LinePoint2, const struct FVector& lineVec2)
{
...
void UVictoryBPFunctionLibrary::STATIC_WidgetGetChildrenOfClass(class UWidget* ParentWidget, TArray<class UUserWidget*>* ChildWidgets, class UClass* WidgetClass, bool bImmediateOnly)
{
...
void UVictoryBPFunctionLibrary::STATIC_Visibility__GetRenderedActors(class UObject* WorldContextObject, TArray<class AActor*>* CurrentlyRenderedActors, float MinRecentTime)
{
...
// float                          MinRecentTime                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
void UVictoryBPFunctionLibrary::STATIC_Visibility__GetNotRenderedActors(class UObject* WorldContextObject, TArray<class AActor*>* CurrentlyNotRenderedActors, float MinRecentTime)
{
...
void UVictoryBPFunctionLibrary::STATIC_VictorySimulateKeyPress(class APlayerController* ThePC, const struct FKey& Key, TEnumAsByte<Engine_EInputEvent> EventType)
{
...
void UVictoryBPFunctionLibrary::STATIC_VictoryISM_ConvertToVictoryISMActors(class UObject* WorldContextObject, class UClass* ActorClass, TArray<class AVictoryISM*>* CreatedISMActors, bool DestroyOriginalActors, int MinCountToCreateISM)
{
...
void UVictoryBPFunctionLibrary::STATIC_VictoryIntPlusEquals(int* Int, int Add, int* IntOut)
{
...
// int                            IntOut                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
void UVictoryBPFunctionLibrary::STATIC_VictoryIntMinusEquals(int* Int, int Sub, int* IntOut)
{
...
void UVictoryBPFunctionLibrary::STATIC_VictoryFloatPlusEquals(float* Float, float Add, float* FloatOut)
{
...
// float                          FloatOut                       (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
void UVictoryBPFunctionLibrary::STATIC_VictoryFloatMinusEquals(float* Float, float Sub, float* FloatOut)
{
...
void UVictoryBPFunctionLibrary::STATIC_VictoryCreateProc(int* ProcessId, const struct FString& FullPathOfProgramToRun, TArray<struct FString> CommandlineArgs, bool Detach, bool Hidden, int Priority, const struct FString& OptionalWorkingDirectory)
{
...
void UVictoryBPFunctionLibrary::STATIC_VictoryAppendInline(struct FString* String, const struct FString& ToAppend, struct FString* Result, bool AppendNewline)
{
...
class UTexture2D* UVictoryBPFunctionLibrary::STATIC_Victory_LoadTexture2D_FromFile_Pixels(const struct FString& FullFilePath, VictoryBPLibrary_EJoyImageFormats ImageFormat, bool* IsValid, int* Width, int* Height, TArray<struct FLinearColor>* OutPixels)
{
...
// int                            Height                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UTexture2D*              ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
class UTexture2D* UVictoryBPFunctionLibrary::STATIC_Victory_LoadTexture2D_FromFile(const struct FString& FullFilePath, VictoryBPLibrary_EJoyImageFormats ImageFormat, bool* IsValid, int* Width, int* Height)
{
...
TEnumAsByte<AIModule_EPathFollowingRequestResult> UVictoryBPFunctionLibrary::STATIC_Victory_AI_MoveToWithFilter(class APawn* Pawn, const struct FVector& Dest, class UClass* FilterClass, float AcceptanceRadius, bool bProjectDestinationToNavigation, bool bStopOnOverlap, bool bCanStrafe)
{
...
void UVictoryBPFunctionLibrary::STATIC_UnloadStreamingLevel(class ULevelStreamingDynamic* LevelInstance)
{
...
void UVictoryBPFunctionLibrary::STATIC_StringConversion__GetFloatAsStringWithPrecision(float TheFloat, struct FString* TheString, int Precision, bool IncludeLeadingZero)
{
...
void UVictoryBPFunctionLibrary::STATIC_String__ExplodeString(TArray<struct FString>* OutputStrings, const struct FString& InputString, const struct FString& Separator, int Limit, bool bTrimElements)
{
...
void UVictoryBPFunctionLibrary::STATIC_ServerTravel(class UObject* WorldContextObject, const struct FString& MapName, bool bSkipNotifyPlayers)
{
...
void UVictoryBPFunctionLibrary::STATIC_Selection_SelectionBox(class UObject* WorldContextObject, TArray<class AActor*>* SelectedActors, const struct FVector2D& AnchorPoint, const struct FVector2D& DraggedPoint, class UClass* ClassFilter)
{
...
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UVictoryBPFunctionLibrary::STATIC_ScreenShots_Rename_Move_Most_Recent(struct FString* OriginalFileName, const struct FString& NewName, const struct FString& NewAbsoluteFolderPath, bool HighResolution)
{
...
void UVictoryBPFunctionLibrary::STATIC_SaveGameObject_GetMostRecentSaveSlotFileName(struct FString* Filename, bool* bFound)
{
	static auto fn = UObject::FindObject<UFunction>("Function VictoryBPLibrary.VictoryBPFunctionLibrary.SaveGameObject_GetMostRecentSaveSlotFileName");

	UVictoryBPFunctionLibrary_SaveGameObject_GetMostRecentSaveSlotFileName_Params params;
...
class UAudioComponent* UVictoryBPFunctionLibrary::STATIC_PlaySoundAttachedFromFile(const struct FString& FilePath, class USceneComponent* AttachToComponent, const struct FName& AttachPointName, const struct FVector& Location, TEnumAsByte<Engine_EAttachLocation> LocationType, bool bStopWhenAttachedToDestroyed, float VolumeMultiplier, float PitchMultiplier, float StartTime, class USoundAttenuation* AttenuationSettings)
{
...
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UVictoryBPFunctionLibrary::STATIC_OptionsMenu__GetDisplayAdapterScreenResolutions(TArray<int>* Widths, TArray<int>* Heights, TArray<int>* RefreshRates, bool IncludeRefreshRates)
{
...
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UVictoryBPFunctionLibrary::STATIC_Mobility__SetSceneCompMobility(class USceneComponent* SceneComp, TEnumAsByte<Engine_EComponentMobility> NewMobility)
{
...
// struct FString                 FullFilePath                   (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UVictoryBPFunctionLibrary::STATIC_LoadStringFromFile(struct FString* Result, const struct FString& FullFilePath)
{
...
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UVictoryBPFunctionLibrary::STATIC_LoadStringArrayFromFile(TArray<struct FString>* StringArray, int* ArraySize, const struct FString& FullFilePath, bool ExcludeEmptyLines)
{
...
void UVictoryBPFunctionLibrary::STATIC_JoyGraphicsSettings__FullScreen_Set(TEnumAsByte<VictoryBPLibrary_EJoyGraphicsFullScreen> NewSetting)
{
...
TEnumAsByte<VictoryBPLibrary_EJoyGraphicsFullScreen> UVictoryBPFunctionLibrary::STATIC_JoyGraphicsSettings__FullScreen_Get()
{
...
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UVictoryBPFunctionLibrary::STATIC_JoyFileIO_GetFilesInRootAndAllSubFolders(TArray<struct FString>* Files, const struct FString& RootFolderFullPath, const struct FString& Ext)
{
...
// struct FString                 Ext                            (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UVictoryBPFunctionLibrary::STATIC_JoyFileIO_GetFiles(TArray<struct FString>* Files, const struct FString& RootFolderFullPath, const struct FString& Ext)
{
...
// Parameters:
// class ULevelStreamingDynamic*  LevelInstance                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
void UVictoryBPFunctionLibrary::STATIC_HideStreamingLevel(class ULevelStreamingDynamic* LevelInstance)
{
...
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UVictoryBPFunctionLibrary::STATIC_HasSubstring(const struct FString& SearchIn, const struct FString& SubString, TEnumAsByte<CoreUObject_ESearchCase> SearchCase, TEnumAsByte<CoreUObject_ESearchDir> SearchDir)
{
...
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UVictoryBPFunctionLibrary::STATIC_GetViewportPositionHitResultByChannel(class UObject* WorldContextObject, const struct FVector2D& ViewportPosition, TEnumAsByte<Engine_ECollisionChannel> TraceChannel, bool bTraceComplex, struct FHitResult* OutHitResult)
{
...
struct FLevelStreamInstanceInfo UVictoryBPFunctionLibrary::STATIC_GetLevelInstanceInfo(class ULevelStreamingDynamic* LevelInstance)
{
...
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UVictoryBPFunctionLibrary::STATIC_FileIO__SaveStringTextToFile(const struct FString& SaveDirectory, const struct FString& JoyfulFileName, const struct FString& SaveText, bool AllowOverWriting, bool AllowAppend)
{
	...
	params.AllowAppend = AllowAppend;
...
// bool                           AllowAppend                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
bool UVictoryBPFunctionLibrary::STATIC_FileIO__SaveStringArrayToFile(const struct FString& SaveDirectory, const struct FString& JoyfulFileName, TArray<struct FString> SaveText, bool AllowOverWriting, bool AllowAppend)
{
...
// TEnumAsByte<CoreUObject_ESearchCase> SearchCase                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int                            ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
int UVictoryBPFunctionLibrary::STATIC_CountOccurrancesOfSubString(const struct FString& Source, const struct FString& SubString, TEnumAsByte<CoreUObject_ESearchCase> SearchCase)
{
...
class AStaticMeshActor* UVictoryBPFunctionLibrary::STATIC_Clone__StaticMeshActor(class UObject* WorldContextObject, bool* IsValid, class AStaticMeshActor* ToClone, const struct FVector& LocationOffset, const struct FRotator& RotationOffset)
{
